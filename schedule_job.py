    ...
    for i in range(1, 8):
        ...
        os.system("gcloud compute ssh -q {instance_name} --zone us-central1-a \
                  --command 'source ~/.bash_profile && \
                             ...
                             gsutil cp /home/kokihikichi/am_scraper/item_links.pickle gs://am-scraped/bk/{instance_name}-item_links.pickle &&\
                             gsutil cp /home/kokihikichi/am_scraper/current_url.pickle gs://am-scraped/bk/{instance_name}-current_url.pickle'".format(instance_name=instance_name))
